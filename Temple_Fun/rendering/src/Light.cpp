...
namespace rendering
{
    ...
    void Light::draw(rendering::Camera *camera, rendering::ShaderManager &LightProgram, glm::mat4 ProjMatrix, glm::mat4 NormalMatrix, game::Player &player)
    {
        ...
        glm::vec4 LightPos =  camera->getViewMatrix() * glm::vec4(player.convertCoord(),1.0);        LightProgram.uniform3f("uLightPos_vs", LightPos.x, LightPos.y, LightPos.z);
